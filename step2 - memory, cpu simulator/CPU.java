...
public class CPU {
	...
	public int[] fetch() {
		this.register.PC += 1;
		return this.memory.fetch(this.register.PC-1);
	}
	
	public int[][] dump() {
		int[][] registerArr = {this.register.R1, this.register.R2, this.register.R3, this.register.R4, this.register.R5, this.register.R6, this.register.R7};
		return registerArr;
	}
